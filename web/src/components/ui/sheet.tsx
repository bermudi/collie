    ...
    >
      ...
      <button
        ...
        className={cn(
          ...
          // decelerating curve: the slide then plays against a stable ground. `skipEntrance` is
          // upstream's sticky "opened from a peek" flag — their rename of the one-render
          // `continuingFromPeek` (see the comment above the hook).
          !peeking && !skipEntrance &&
