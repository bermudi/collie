...
import { useLaunchers, useLaunchersHome } from "@/lib/operator-config";
            ...
            return (
              ...
              >
                <span className="flex items-center gap-1.5">
                  ...
                  {/* The pinned folder, shortened under home. From the dashboard the implied folder
                      is already home, so when it IS home there is no suffix to show. */}
                  {shortenHome(launcher.cwd, home) !== "~" && (
