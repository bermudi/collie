...
export const Composer = forwardRef<ComposerHandle, ComposerProps>(function Composer(
  { paneId, scope, agent, isShell, gone, readOnly, composing, dialogPresent, dialogUnread, text, terminalDraft, rawTerminalDraft, prefs, setWrap, stepFontSize, setRawTerminal, setTapToFocus, mirrorNative, setMirrorNative, setExpandClippedReply, onSent, pullHandle, draftNoticeSlot, changesPill },
  ref,
) {
  ...
  // Whether there is anything to send: typed text or a chip waiting on it (ADR 0060's marker means
  // a draft with only a marker is still a send, and an EMPTY box with chips is too).
  ...
  async function onPasteFile(e: ClipboardEvent<HTMLTextAreaElement>) {
