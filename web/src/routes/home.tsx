...
// them (and like it, they fold), while Spaces is the navigator below. Tapping an agent opens its
// pane; tapping a space drills into /space/:id.
    ...
    <div className="mx-auto flex min-h-0 w-full max-w-screen-sm flex-1 flex-col overflow-hidden">
      ...
      <div className="flex min-h-0 flex-1 flex-col overflow-y-auto overscroll-contain">
        ...
        <main className="flex-1">
          ...
          />
          <LaunchStrip open={prefs.launchOpen} onOpenChange={setLaunchOpen} />
          <SpaceOverview
