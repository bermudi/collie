...
// arbitrary line the client gets to run. Anything not in `launchers.toml` is a 400 before herdr is
// ever touched, and that lookup is the whole security story of the route.
 ...
 */
export function uploadFile(paneId: string, file: File, session?: string): Promise<UploadResponse> {
