...
const CODEX: readonly AgentCommand[] = [
  ...
  { command: "/model", description: "Switch the active model and reasoning effort", takesArg: true, argHint: "<model>", common: true, dangerous: false }, // harness-bar
...
const DEVIN: readonly AgentCommand[] = [
  ...
  { command: "/fast", description: "Switch to the fast model (SWE-1.x Fast/Lightning)", takesArg: false, argHint: "", common: true, dangerous: false },
  ...
  { command: "/autonomous", description: "Switch to Autonomous mode (sandbox-enforced; needs --sandbox)", takesArg: false, argHint: "", common: false, dangerous: false },
  ...
  { command: "/theme", description: "Switch between dark, light, terminal, and no-color themes", takesArg: false, argHint: "", common: false, dangerous: false },
  ...
  { command: "/fork", description: "Fork the session to a new one, optionally from a step", takesArg: true, argHint: "[step]", common: false, dangerous: false },
  { command: "/steps", description: "List conversation steps (for /fork and /revert)", takesArg: false, argHint: "", common: false, dangerous: false },
  { command: "/revert", description: "Revert file changes and rewind the conversation to before a step", takesArg: true, argHint: "<step>", common: false, dangerous: true },
  { command: "/title", description: "Rename the current session", takesArg: true, argHint: "<title>", common: false, dangerous: false },
  ...
  { command: "/btw", description: "Ask a side question from context without touching the transcript", takesArg: true, argHint: "<question>", common: false, dangerous: false },
  { command: "/hooks", description: "List loaded hooks and their event types", takesArg: false, argHint: "", common: false, dangerous: false },
  { command: "/mcp", description: "List configured MCP servers and their status", takesArg: false, argHint: "", common: false, dangerous: false },
  { command: "/shortcuts", description: "Browse and rebind keyboard shortcuts", takesArg: false, argHint: "", common: false, dangerous: false },
  { command: "/config", description: "Open the interactive config editor", takesArg: false, argHint: "", common: false, dangerous: false },
  { command: "/login", description: "Authenticate with Devin", takesArg: false, argHint: "", common: false, dangerous: false },
  { command: "/login-status", description: "Show login and authentication status", takesArg: false, argHint: "", common: false, dangerous: false },
  { command: "/org", description: "Select your Devin organization", takesArg: false, argHint: "", common: false, dangerous: false },
  { command: "/logout", description: "Clear stored credentials and exit", takesArg: false, argHint: "", common: false, dangerous: true },
  { command: "/copy", description: "Copy the last response to the clipboard", takesArg: false, argHint: "", common: false, dangerous: false },
  { command: "/feedback", description: "Rate the last response up or down", takesArg: true, argHint: "<up|down>", common: false, dangerous: false },
  { command: "/mouse", description: "Toggle mouse event capture in menus", takesArg: false, argHint: "", common: false, dangerous: false },
  { command: "/context", description: "Show context window usage", takesArg: false, argHint: "", common: false, dangerous: false },
  { command: "/usage", description: "Show estimated credit/ACU usage for the session", takesArg: false, argHint: "", common: false, dangerous: false },
  { command: "/session-stats", description: "Show full session statistics (alias: /stats)", takesArg: false, argHint: "", common: false, dangerous: false },
  { command: "/cloud-sessions", description: "Browse and open recent cloud Devin sessions (insiders)", takesArg: false, argHint: "", common: false, dangerous: false },
