...
export class HerdrClient {
   ...
   *
   *  Almost every queue is one `pane.send_keys` RPC; Shift+Tab uses a raw `pane.send_text` BackTab
   *  sequence because affected Herdr releases mis-encode the named chord. */
